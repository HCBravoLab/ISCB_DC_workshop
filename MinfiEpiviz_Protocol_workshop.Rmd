...
## 0. Preliminaries on R/Bioconductor
...
Alternatively, these datasets can be read in from .csv files located on Github.

```{r,eval=F,results="hide"}
library(RCurl)

meth.set.URL <- getURL("https://raw.githubusercontent.com/
  HCBravoLab/ISCB_DC_workshop/master/data/methset_data.csv")
meth.set <- read.delim(text=meth.set.URL,sep="\t",stringsAsFactors=FALSE)

gen.meth.set.URL <- getURL("https://raw.githubusercontent.com/HCBravoLab/
  ISCB_DC_workshop/master/data/genmethset_data.csv")
gen.meth.set <- read.delim(text=gen.meth.set.URL,sep="\t",stringsAsFactors=FALSE)

gen.rat.set.URL <- getURL("https://raw.githubusercontent.com/HCBravoLab/
  ISCB_DC_workshop/master/data/genratset_data.csv")
gen.rat.set <- read.delim(text=gen.rat.set.URL,sep="\t",stringsAsFactors=FALSE)
```
